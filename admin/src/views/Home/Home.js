      ...
      <Layout>
        <Layout.Section>
          <Banner
            ...
            status="warning"
            action={{ content: 'View Orders', url: '/Teacher' }}
          ></Banner>
        </Layout.Section>
        <Layout.Section oneHalf>
          <Card
            title="Marketing"
            sectioned
            primaryFooterAction={{ content: 'View', url: '/Marketing' }}
          >
        ...
        <Layout.Section oneHalf>
          <Card
            title="Products"
            sectioned
            primaryFooterAction={{ content: 'View', url: '/Product' }}
          >
        ...
        <Layout.Section oneHalf>
          <Card
            ...
            sectioned
            primaryFooterAction={{ content: 'View', url: '/Rental' }}
          >
        ...
        <Layout.Section oneHalf>
          <Card
            title="Teachers"
            sectioned
            primaryFooterAction={{ content: 'View', url: '/Teacher' }}
          >
            <p>Manage Schools & Teachers</p>
          </Card>
        </Layout.Section>
      </Layout>
    </Page>
